...
namespace EWinApp.Tools.Test.actions
{
	public partial class TestAction
	{
		public void InstallR7()
		{
			...
			double currentRadius = 1450.0.FromMillimeters();   // Vòng đầu tiên cách tâm 1450 mm
			double thresholdRadius = 7930.0.FromMillimeters(); // Mốc thay đổi khoảng cách rải
			...
			while (currentRadius <= maxRadius)
			{
                ...
                // Nếu bán kính hiện tại >= mốc 7930mm thì bước nhảy là 200mm, ngược lại là 120mm
